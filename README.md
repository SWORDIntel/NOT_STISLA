...
The AVX512 version falls under the same license terms as the AVX2 implementation - it is considered a derivative work not requiring separate licensing arrangements. 

Commercial use of AVX512 optimizations is prohibited without explicit written agreement.
